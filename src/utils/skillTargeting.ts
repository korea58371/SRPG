...
export const MOCK_SKILLS: Record<string, Skill> = {
  ...
  'mock-ambush': { id: 'mock-ambush', name: '기습', description: '[t:단일 대상]에게 [v:150%]의 [a:물리 피해]를 입히고 [v:1칸 밀어냅니다].', range: 1, aoeShape: 'single', aoeRadius: 0, targetType: 'enemy', requiresTarget: true, cost: [{type: 'mp', amount: 10}], effects: [{type: 'damage', value: 1.5, element: 'pierce'}, {type: 'push', value: 1}] },
